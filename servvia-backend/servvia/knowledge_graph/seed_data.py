"""
ServVia 2.0 - Knowledge Graph Seed Data
25 Herbs and 15 Diseases with Evidence
"""
...
HERBS_DATA = [
    ...
    {'name': 'Apple Cider Vinegar', 'scientific_name': 'Malus domestica (fermented)', 'description': 'Fermented apple juice', 'traditional_uses': ['blood sugar', 'weight loss'], 'contraindications': ['GERD', 'low potassium'], 'drug_interactions': ['diabetes medications', 'diuretics']},
