...
Run this AFTER starting the server:
    cd C:\\Users\\cools\\servviaAI\\servvia
...
def check_server():
    ...
    print(f"\n  Start it with:")
    print(f"    cd C:\\Users\\cools\\servviaAI\\servvia")
...
def demo_objective_4():
    ...
    info("  core_temporal/knowledge_graph/schema.py — using in-memory repository for demo")
