...
from legacy_agriculture.common.utils import send_request
...
def content_retrieval(
    ...
    try:
        # Use configured Farmstack email so any user can retrieve chunks
        retrieval_email = Config.FARMSTACK_RETRIEVAL_EMAIL or email
        response = send_request(
            content_retrieval_url,
            data={"email": retrieval_email, "query": original_query},
            content_type="JSON",
            request_type="POST",
            total_retry=3,
        )
