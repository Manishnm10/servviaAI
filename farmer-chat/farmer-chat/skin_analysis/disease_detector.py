"""
Enhanced Skin Disease Detection using Google Gemini 2.0 Flash
...
def validate_skin_image(image_path: str) -> dict:
    ...
    try: 
        ...
        # Calculate how similar R, G, B channels are
...
def detect_skin_disease_gemini(image_path: str):
    """Main detection function using Gemini AI"""
    ...
    try:
        ...
        # Enhanced prompt for skin disease detection
        prompt = f"""You are an expert dermatologist AI.  Analyze this skin image with precision. 
...
- ACNE: Primarily on FACE, CHEST, UPPER BACK with comedones
- FOLLICULITIS: Bumps CENTERED around HAIR FOLLICLES
...
Analyze this image now: """
        ...
        logger.info(f"🔬 Analyzing with ServVia AI...")
        ...
        logger. info(f"   AI diagnosis: {detected_condition} ({confidence}%)")
        
        # Measure physical features
